...
function processImageData(oImg, binaryData)
{
    var oEXIF = findEXIFinJPEG(binaryData);
    oImg.exifdata = oEXIF || {};
}
...
//EXIF.getBinaryData = function(oImg, binaryData, fncCallback)
//{
//    if (!oImg.complete) return false;
//    if (!imageHasData(oImg)) {
//        processImageData(oImg, binaryData, fncCallback);
//    } else {
//        if (fncCallback) fncCallback();
//    }
//    return true;
...
// TODO: (vlad.lego) disabled autoload
...
jQuery.fn.exifBinaryLoad = function(binaryData) {
    this.each(function() {
        processImageData(this, binaryData);
    });
};
